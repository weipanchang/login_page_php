...
<h2 style="color:blue; text-decoration: underline ">Search AireTalk Member Page</h2>
<!--<p style="color:red">
Warning: This page is only to allow PingShow Controller to access.<br> 
</p>-->
<p style="color:blue">
Search Airetalk Member
</p>

<form method="post" action="Airetalk_member.php">
...
<tr>
<td style="color:blue" ><span style ="font-style:italic;font-size:70%;color:black">Search with member creation date</span> Start Date YYYY-MM-DD</td>
<td><input type="text" name="start_time" size="8" value=""</td>
</tr>

<tr>
<td style="color:blue" ><span style ="font-style:italic;font-size:70%;color:black">Search with member creation date</span> End Date YYYY-MM-DD</td>
